...
const LogIn = () => {
  ...
  const { TravelDatasAll, inputValue, setInputValue } =
      ...
      <div className="h-screen flex justify-center items-center bg-blue-100 login-main ">
        ...
        {registerSwitch ? (
          <form className="md:w-[28%] md:h-[60%] rounded-2xl login-form">
            ...
            <button className="ring-2 ring-white p-3" onClick={registerUser}>
              Register
            </button>
          ...
          <form
            action=""
            className="md:w-[28%] md:h-[60%] rounded-2xl login-form"
          >
